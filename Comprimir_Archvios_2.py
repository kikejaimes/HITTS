...
#Ingresos pqr
with zipfile.ZipFile('D:\Informes\BASES DIARIAS PQR\BDD_Ingresos_pqr_Dic_2023_0.zip', 'w') as archivo_zip:
    archivo_zip.write('D:\Informes\BASES DIARIAS PQR\BDD_Ingresos_pqr_Dic_2023_0.xls', os.path.basename('BDD_Ingresos_pqr_Dic_2023_0.xls'), compress_type=zipfile.ZIP_DEFLATED)

#Finalizados PQR
with zipfile.ZipFile('D:\Informes\BASES DIARIAS PQR\BDD_Finalizados_Pqr_Dic_2023.zip', 'w') as archivo_zip:
    archivo_zip.write('D:\Informes\BASES DIARIAS PQR\BDD_Finalizados_Pqr_Dic_2023.xls', os.path.basename('BDD_Finalizados_Pqr_Dic_2023.xls'), compress_type=zipfile.ZIP_DEFLATED)
...
messagebox.showinfo(message="hola joven luchito los archivos fueron comprimidos gracias  ", title="Título")
